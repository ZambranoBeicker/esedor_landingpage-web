...
const Gracias = ()=>{
  ...
  return(
    <div className="w-8/12 px-4 lg:pl-10">
      <h1 className="text-6xl font-light mt-10 mb-8 text-gray-secondary">Tu consulta fue enviada con éxito</h1>
      <p className="text-gray-second ml-1 mb-20">Pronto uno de nuestros asesores se pondrá en contacto contigo o puedes agendar una videollamada</p>
