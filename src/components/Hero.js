    ...
    return(
        <section className="overflow-hidden relative pt-24 sm:flex sm:pb-24 lg:py-0 bg-blue-third duration-200 lg:pt-10" id="hero">
            <Header />
              <Group3d />
            <HeroInfo />
            <div className="mt-10 relative my-index sm:ml-5 md:ml-0 hero-form-container">
              <h4 className="font-bold semibig hidden lg:block mb-8 px-16 query-info text-center">Solicita más información<br></br>o llámos (01) 773-8905</h4>
