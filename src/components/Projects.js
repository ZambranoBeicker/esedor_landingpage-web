      ...
      return (
        ...
        <React.Fragment>
          ...
          <ArrowCta  title="Llámanos (+51)773 8905" containerClass="rounded-md hidden md:flex lg:w-32 mx-auto md:mx-0 sm:ml-6 bg-blue text-shadow " ctaClass="mr-auto" src="images/llamada.png" adapt={false}/>
            ...
            <HeroForm formClass="bg-black min-h-0 py-1 px-2 rounded-t-md mx-auto" buttonId="projects-formButton" containerForm="form-container md:px-4 mx-auto lg:w-auto lg:ml-0 lg:mr-16 sm:w-56"/>
          </div>
